...
// TST2-H2: prod-host guard via shared helper. Pool was previously
// constructed at module-load, so even importing this file would
// touch the DB.
...
assertSafeTargetDb({ forceEnv: 'TEST_CONCURRENT_FORCE', scriptId: 'test-concurrent-same-entity' });
