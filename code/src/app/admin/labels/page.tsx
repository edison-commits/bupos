...
export default function LabelsPage() {
  ...
  const searchProducts = useCallback(async (query: string) => {
    ...
    try {
      ...
      data.products?.forEach((p: { id: string; name: string; variants?: Array<{ id: string; sku: string; variant_name: string; size_label: string | null; color_label: string | null; price: number }> }) => {
