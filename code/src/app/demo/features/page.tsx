      ...
      <header className="border-b border-[#15201f]/15 bg-[#f4f1eb]">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-5 sm:px-8">
          ...
          <nav className="flex items-center gap-5 text-sm">
            <Link href="#screens" className="hidden text-[#52605d] hover:text-[#0b8279] sm:inline">See BUPOS</Link>
            <Link href="#features" className="hidden text-[#52605d] hover:text-[#0b8279] sm:inline">Feature reference</Link>
            <a href="mailto:edison@idiotic.solutions?subject=BUPOS%20walkthrough" className="hidden text-[#52605d] hover:text-[#0b8279] sm:inline">Book a walkthrough</a>
      ...
      <section className="mx-auto max-w-6xl px-5 pb-16 pt-14 sm:px-8 sm:pb-24 sm:pt-24">
        <div className="grid items-center gap-12 lg:grid-cols-[0.82fr_1.18fr]">
          <div>
            ...
            <p className="mt-7 max-w-xl text-xl leading-8 text-[#52605d]">BUPOS connects the register, size-and-color catalog, stockroom, purchasing, customers, and manager view—so the store team can stay with the customer instead of chasing the system.</p>
            ...
            <p className="mt-5 text-sm text-[#697572]">No signup, nothing to install, and no real checkout actions.</p>
          </div>
          <figure className="overflow-hidden rounded-[1.5rem] border border-[#15201f]/15 bg-white shadow-[0_24px_70px_rgba(21,32,31,0.14)]">
            ...
            <figcaption className="border-t border-[#15201f]/10 px-5 py-3 text-xs text-[#697572]">Sample register view · simulated store data</figcaption>
          </figure>
        </div>
      </section>
